...
// // default foto die gebruikt wordt wanneer een foto niet gevonden kan worden
// import MissingPicture from "../../../assets/pictures/webp/MissingPicture.webp";
// const Default_ImagePlaceholder = MissingPicture;

// /**
//  * 
//  * @param ImagePath parameter die nodig is om de te zoeken voor de correcte pad van de foto die gebruikt moet worden voor het veilingproduct 
//  * @param headerText 
//  * @param paragraafText
//  * @param veilingnr
//  * @returns 
